...
This project presents an Excel-based analysis of hotel booking cancellations. The goal was to uncover patterns and factors that contribute to reservation cancellations using **Pivot Tables**, **Pivot Charts**, and basic Excel analytics tools — without using any programming or database tools.
